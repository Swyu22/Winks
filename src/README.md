...
| `components/` | 纯 UI 组件（PinModal/Logo/LinkCard/LinkModal/CategorySidebar/MobileCategoryBar），不直接调用 Supabase |
...
2026-06-05 复跑得分 98/100；剩余项主要是自定义 modal 迁移 `<dialog>`、`LinkModal` reducer 化与少量颜色对比提示。
