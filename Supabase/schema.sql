...
create table if not exists public.links (
  ...
  category text not null default '__WINKS_META__{"classification":"未分类","tags":["设计"]}' check (char_length(category) <= 2000),
...
alter table public.links
  alter column category set default '__WINKS_META__{"classification":"未分类","tags":["设计"]}';
